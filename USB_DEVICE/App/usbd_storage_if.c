...
uint8_t STORAGE_Disk[STORAGE_BLK_NBR * STORAGE_BLK_SIZ];
...
int8_t STORAGE_Read_HS(uint8_t lun, uint8_t *buf, uint32_t blk_addr, uint16_t blk_len)
{
  ...
  memcpy(buf, (uint8_t*)(STORAGE_Disk + blk_addr * STORAGE_BLK_SIZ), blk_len * STORAGE_BLK_SIZ);
...
int8_t STORAGE_Write_HS(uint8_t lun, uint8_t *buf, uint32_t blk_addr, uint16_t blk_len)
{
  ...
  memcpy(STORAGE_Disk + blk_addr*STORAGE_BLK_SIZ, buf, blk_len * STORAGE_BLK_SIZ);
